...
export type AdminRoute = "dashboard" | "volunteers" | "cycles" | "candidates" | "races" | "ballot-measures" | "fec" | "calendar-events";

const VALID_ROUTES: AdminRoute[] = ["dashboard", "volunteers", "cycles", "candidates", "races", "ballot-measures", "fec", "calendar-events"];
