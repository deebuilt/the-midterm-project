...
export type AdminRoute = "dashboard" | "volunteers" | "cycles" | "candidates" | "races" | "ballot-measures" | "fec" | "calendar-events" | "states";

const VALID_ROUTES: AdminRoute[] = ["dashboard", "volunteers", "cycles", "candidates", "races", "ballot-measures", "fec", "calendar-events", "states"];
